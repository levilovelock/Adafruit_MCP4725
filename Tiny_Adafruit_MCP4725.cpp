...
*/
/**************************************************************************/
Tiny_Adafruit_MCP4725::Tiny_Adafruit_MCP4725() {
}
...
*/
/**************************************************************************/
void Tiny_Adafruit_MCP4725::begin(uint8_t addr) {
  _i2caddr = addr;
  TinyWireM.begin();
}
...
*/
/**************************************************************************/
void Tiny_Adafruit_MCP4725::setVoltage( uint16_t output, bool writeEEPROM )
{
#ifdef TWBR
  ...
  if (writeEEPROM)
  {
    TinyWireM.write(MCP4726_CMD_WRITEDACEEPROM);
  }
  else
  {
    TinyWireM.write(MCP4726_CMD_WRITEDAC);
  }
  TinyWireM.write(output / 16);                   // Upper data bits          (D11.D10.D9.D8.D7.D6.D5.D4)
  TinyWireM.write((output % 16) << 4);            // Lower data bits          (D3.D2.D1.D0.x.x.x.x)
